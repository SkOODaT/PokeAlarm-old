...
from PokeAlarm.Utils import parse_boolean, get_static_map_url, \
    reject_leftover_parameters, require_and_remove_key, get_image_url, get_color
...
class DiscordAlarm(Alarm):
    ...
    _defaults = {
        ...
        'weather': {
            'username': "Weather",
            'content': "",
            'icon_url': get_image_url("weather/weather.png"),
            'avatar_url': get_image_url("weather/weather.png"),
